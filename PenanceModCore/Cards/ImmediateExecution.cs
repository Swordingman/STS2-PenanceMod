...
{
    // 耗能 1，类�?Attack，稀有度 Uncommon，目�?AnyEnemy
    ...
    protected override IEnumerable<DynamicVar> CanonicalVars => [
        new DynamicVar("Execution-Judge", 3m).WithTooltip("PENANCEMOD-JUDGEMENT")
    ];
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        // 稍微停顿一下，让上 Buff 的特效播完，增加“行刑”的节奏�?
        await Cmd.Wait(0.2f);

        // ==========================================
        // 2. 获取当前的裁决总层�?(此时必定已经包含了刚刚加上的层数)
        // ==========================================
