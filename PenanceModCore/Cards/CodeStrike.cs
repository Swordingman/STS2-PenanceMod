...
public class CodeStrike : PenanceBaseCard
{
    private const int Threshold = 7;

    // 耗能 0，类型 Attack，稀有度 Common，目标 AnyEnemy
    public CodeStrike() : base(0, CardType.Attack, CardRarity.Common, TargetType.AnyEnemy, true)
    {
    }
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        int unblockedDamage = attackCmd.Results
